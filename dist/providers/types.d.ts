...
export declare function isProviderError(err: unknown): err is ProviderError;
export declare function makeProviderError(code: "PROVIDER_TIMEOUT" | "PROVIDER_UNAVAILABLE", message: string): ProviderError;
