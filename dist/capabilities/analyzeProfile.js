import { AnalyzeProfileInputSchema, } from "../schemas/inputs.js";
import { isProviderError } from "../providers/types.js";
import { getTaxonomyById, resolveTaxonomy, } from "../taxonomy/catalog.js";
...
function toCandidate(entry, confidence) {
    return {
...
function buildDraftFromOutcome(outcome, deps, input) {
    const thresholds = {
        ...DEFAULT_THRESHOLDS,
        ...(deps.thresholds ?? {}),
    };
...
export async function analyzeProfile(rawInput, deps) {
...
//# sourceMappingURL=analyzeProfile.js.map